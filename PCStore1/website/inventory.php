...
if (isset($_POST['ins'])) {
    ...
    if (isset($_GET['pid']) && isset($_SESSION['aid'])) {
        ...
        <table id="tab1" style="width: auto; margin: 0 auto;">
            ...
            <tbody>
                ...
                if (isset($_GET['d'])) {
                    ...
                    // ... (similar code for undelivered orders)
		include("include/connect.php");
